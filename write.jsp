...
<form id="writeForm" name="writeForm" action="write.do" method="post" target="_self" enctype="multipart/form-data" >
...
<tbody>
	<input type="hidden" style="display: inline;" name="writerEmail" value="<%=userEmail %>"/>
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">email</span><input type="text" style="display: inline;" name="email" size="70.3" value="<%=userEmail %>" readonly/></td>
	</tr>
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">글쓴이</span><input type="text" style="display: inline;" name="writer" size="70.3" value="<%=userName %>" readonly/></td>
	</tr>
	<tr>
