	                 	...
	                 	<ul class="main-menu">
		                    ...
		                    <li>
		                       ...
		                       <ul class="sub-menu">
		                          ...
		                          <li><a href="/faq/list.do?cp=1">FAQ</a></li>
		                       </ul>
		                    </li>
							...
							<div class="xans-element- xans-layout xans-layout-boardinfo cboth event_tab">
								<ul>
									<li rel="Q&A" class="xans-record-">
										<a href="/qna/list.do?cp=1" class="move">Q&A</a>
									</li>
									<li rel="FAQ" class="xans-record-">
										<a href="/faq/list.do?cp=1" class="move">FAQ </a>
									</li>
								</ul>
							</div>
							<div class="boardSort">
				...
				<fieldset class="boardSearch">
					<legend>게시물 검색</legend>
						...
						<div style="display: flex; justify-content: right; align-items: center;">
							...
							<input onload="$('#surf').focus()" id="surf" name="surf" fw-filter="" fw-label="" fw-msg="" class="inputTypeText" placeholder="" value="" type="text" style="margin-left: 10px;"/> 
