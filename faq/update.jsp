...
<hr class="layout"/><div id="wrap">
	...
	<li rel="Q&A" class="xans-record-"><a href="/qna/list.do" class="move">Q&A</a></li>
	<li rel="FAQ" class="xans-record-"><a href="/faq/list.do" class="move">FAQ </a></li>

		</ul>
</div>
<form id="updateForm" name="updateForm" action="update.do" method="post" target="_self" enctype="multipart/form-data" >
...
<tbody>
	<tr>
		<td class="board_subject"  colspan="2"><span style="padding-right: 10px;">제목</span><input type="text" style="display: inline;" name="subject" size="60" value="${faq.subject}"/></td>
	</tr>
	<tr>
		<td colspan="2">
